    ...
    export namespace GCalc {
        ...
        class EquationManager extends GObject.Object implements MathEquationManager {
            ...
            emit<K extends keyof EquationManager.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<EquationManager.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class ErrorExpression extends Expression {
            ...
            emit<K extends keyof ErrorExpression.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<ErrorExpression.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class ExpressionHashMap extends Gee.HashMap {
            ...
            emit<K extends keyof ExpressionHashMap.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<ExpressionHashMap.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        namespace MathConstant {
            /**
             * Interface for implementing MathConstant.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathConstantComplex {
            /**
             * Interface for implementing MathConstantComplex.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathConstantNumber {
            /**
             * Interface for implementing MathConstantNumber.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathConstantVector {
            /**
             * Interface for implementing MathConstantVector.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathErrorResult {
            /**
             * Interface for implementing MathErrorResult.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathExpression {
            /**
             * Interface for implementing MathExpression.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathFunction {
            /**
             * Interface for implementing MathFunction.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathGroup {
            /**
             * Interface for implementing MathGroup.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathParameter {
            /**
             * Interface for implementing MathParameter.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathPolynomial {
            /**
             * Interface for implementing MathPolynomial.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathResult {
            /**
             * Interface for implementing MathResult.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathTerm {
            /**
             * Interface for implementing MathTerm.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
        ...
        namespace MathVariable {
            /**
             * Interface for implementing MathVariable.
             * Contains only the virtual methods that need to be implemented.
             */
            interface Interface {
                // Virtual methods
