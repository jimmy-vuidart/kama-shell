    ...
    export namespace GtkVnc {
        ...
        namespace CairoFramebuffer {
            ...
            interface ConstructorProps
                extends GVnc.BaseFramebuffer.ConstructorProps, GVnc.Framebuffer.ConstructorProps {
                surface: any;
            }
        }
        ...
        class CairoFramebuffer extends GVnc.BaseFramebuffer implements GVnc.Framebuffer {
            ...
            emit<K extends keyof CairoFramebuffer.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<CairoFramebuffer.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
