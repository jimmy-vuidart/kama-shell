...
declare module 'gi://Mbim?version=1.0' {
    ...
    export namespace Mbim {
        ...
        /**
         * MBIM commands in the {@link Mbim.Service.INTEL_AT_TUNNEL} service.
         * @gir-type Enum
         * @since 1.34
         */
        ...
        enum Service {
            ...
            COMPAL,
            /**
             * Intel at tunnel service. Since 1.34.
             */
            INTEL_AT_TUNNEL,
        }
        ...
        /**
         * Gets the nickname string for the {@link Mbim.CidIntelAtTunnel} specified at `val`.
         * @param val a MbimCidIntelAtTunnel.
         * @returns a string with the nickname, or `null` if not found. Do not free the returned value.
         * @since 1.34
         */
        ...
        class Message {
            ...
            /**
             * Parses and returns parameters of the 'Configuration' notification command in the 'SMS' service.
             * @returns `true` if the message was correctly parsed, `false` if `error` is set.
             */
            sms_configuration_notification_parse(): [
                boolean,
